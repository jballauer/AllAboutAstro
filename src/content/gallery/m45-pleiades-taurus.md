...
description: The Pleiades, acquired remotely via the Prodome 10 Observatory near Crowell, Texas -- 180 miles from home.
pubDate: 2009-11-23
...
The Pleiades in Taurus, in LRGB, the first long-exposure image acquired remotely via the Prodome 10 Observatory.

<div class="ke-two-col">
<div class="ke-two-col-specs">

<p><strong>Observatory:</strong> Prodome 10 Observatory - data acquired via remote from Grapevine, Texas</p>
...
<p><strong>Scope/Mount:</strong> Tak TOA-150 (with 67 Flattener) and Paramount ME mount</p>
<p><strong>Camera:</strong> SBIG STL-11000M astro CCD camera</p>
<p><strong>Exposure Info:</strong> LRGB image; 160:60:50:30 minutes (10 minute subexposures all unbinned)</p>
...
![An earlier attempt at the Pleiades with an SBIG STL-11000M, December 2004](./_images/m45-pleiades-taurus-previous2004.jpg)

<p><strong>Location:</strong> Comanche Springs, 3RF dark sky site near Crowell, Texas<br>
<strong>Seeing:</strong> 9/10<br>
<strong>Transparency:</strong> 8/10<br>
<strong>Temperature:</strong> 35 degrees F<br>
<strong>Date:</strong> December 11, 2004<br>
<strong>Scope/Mount:</strong> Tak FSQ-106 @ f/5 and Tak NJP mount<br>
<strong>Camera:</strong> SBIG STL-11000M astro CCD camera<br>
<strong>Exposure Info:</strong> LRGB image; 60:60:80 RGB with synthetic luminance (5 minute subexposures all unbinned)<br>
<strong>Processing Information:</strong> Calibration, Registration, DDP, and RGB channel combine in MaxIm DL 4. LRGB combine, cropping, color balance, levels/curves, sharpening, and noise removal (despeckle and gaussian blur) in Photoshop CS.</p>

<p><em>Exposure Notes: This was a first light image with the SBIG STL-11000M camera. Conditions were especially good this night. Processing was difficult because I wanted to show the background dust. I largely succeeded, though I should have taken the time for pure luminance. Diffraction spikes were created with a string affixed to the dewshield.</em></p>

![An even earlier attempt at the Pleiades with a Canon Digital Rebel, January 2004](./_images/m45-pleiades-taurus-previous2004canon.jpg)

<p><strong>Location:</strong> Ballauer Observatory in Azle, Texas<br>
<strong>Seeing:</strong> 7/10<br>
<strong>Transparency:</strong> 6/10<br>
<strong>Temperature:</strong> 35 degrees F<br>
<strong>Date:</strong> January 19, 2004 acquired; November 21, 2004 reprocessed<br>
<strong>Scope/Mount:</strong> Tak FSQ-106 @ f/5 and Celestron CGE mount<br>
<strong>Camera:</strong> Canon Digital Rebel<br>
<strong>Guiding:</strong> SBIG ST-7e on the AP 80/900mm guidescope<br>
<strong>Exposure Info:</strong> 8 x 5 minute images<br>
<strong>Processing Information:</strong> All images aligned and combined with a median combine in Images Plus. Photoshop CS was used for dark frame calibration, image cropping, manual gradient removal, saturation increase, levels, curves, sharpening and noise reduction.</p>

<p><em>Exposure Notes: This is a first light image with the new Canon Digital Rebel. The file was saved as a Large JPEG instead of the RAW file format. Thus, lots of information was lost prior to processing. The dark frame calibration was a poor attempt using a single dark frame rather than a master, multi-image dark frame. Diffraction spikes were created with a string affixed to the dewshield.</em></p>
