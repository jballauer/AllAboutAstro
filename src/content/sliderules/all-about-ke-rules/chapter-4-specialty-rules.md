---
title: 'Chapter 4: The Specialty Rules'
description: The Merchant's, Stadia, Chemical, Steam Power, Radio and Electrical, Sector, and Demonstration families of K&E slide rules.
order: 4
draft: false
---
...
A lengthy understanding of stadia surveying is beyond the scope of this article; however, perhaps we can gain quick understanding of the process in order to know how to use most any Stadia slide rule. The important variables and factors are shown below, courtesy of Mike Syphers' amazing and comprehensive [website](https://followingtherules.info/).

<div class="ke-figure">

![A diagram illustrating the variables of stadia surveying: theta, alpha, delta-y, and the derived R value](./_images/ch4-05-stadia-variables-diagram.jpg)

<p class="ke-figure-caption">The variables of stadia surveying, courtesy of Mike Syphers' "Following the Rule" website.</p>
...
<p class="ke-figure-caption">The 20" N4101 Stadia Surveyor's Rule. I stumbled upon this mint rule with case recently. Dating from 1943, produced during World War 2, the very lengthy single-sided Mannheim formatted rule carried an asset sticker on the back from the US Geological Survey. A wonderful piece of history!</p>
...
![The Model 4143 Kissam Stadia, front side](./_images/ch4-07-4143-kissam-stadia-front.jpg)
...
![The Model 4143 Kissam Stadia with slide removed, showing the plastic construction and slide well](./_images/ch4-08-4143-kissam-slide-removed.jpg)
...
![A 1941-dated K&E catalog excerpt referencing the Model 4160 Chemist's Duplex Rule](./_images/ch4-13-4160-chemist-1941.jpg)

<p class="ke-figure-caption">A page from the K&E catalog referencing the Model 4160 Chemist's Duplex Rule, dated 1941.</p>
...
<dt>What it is</dt>
<dd>A 10" Mannheim-style slide rule with celluloid facings on mahogany, cataloged by K&E under the Chemical Family alongside the Model 4160 Chemist's Duplex. Clark McCoy's catalog site, which documents an actual sample from his own collection, describes it plainly as: "The Urea Index Slide Rule is 10" mannheim style slide rule with celluloid facings on mahogany."</dd>
<dt>What it did</dt>
<dd>Per the same source, "the scales are designed for the calculation of Urea Index and Sodium Chloride Formulae" — a single-purpose rule, most plausibly for agricultural, dairy, or clinical chemistry testing of the era, though the source does not elaborate further on the specific formulae or industry.</dd>
<dt>Approx. introduced</dt>
<dd>First shown in the 1916 slide-rule-only catalog; last mentioned in the 1925 catalog.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from Clark McCoy's K&E catalog site, which documents an actual sample from his own collection, not from Jay's own collection, handling, or writing. Treat every detail above as a starting point for research, not settled fact.</p>

<div class="ke-ai-stub-photo" data-hires="/images/ke-rules/ch4-28-4165-urea-index-sample-full.jpg">

![The K&E Model 4165 Urea Index Rule, a 10" Mannheim-style rule with celluloid facings on mahogany, front side and case](./_images/ch4-28-4165-urea-index-sample.jpg)
...
<span class="tag">Verify further:</span> <a href="https://www.mccoys-kecatalogs.com/KEModels/ke4165family.htm">Clark McCoy's K&E Catalog Site</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>A 20" hardwood sewer-computation slide rule bearing the Colby name — likely another design licensed to K&E from Branch H. Colby of St. Louis, the same designer behind the Model 1749-3 Colby's Stadia discussed earlier in this chapter. Clark McCoy's catalog site, which documents this model from K&E catalog archives, describes it as: "unique in its construction. It is made of hardwood and is 20" long." It was first cataloged in 1897 under the model number 1749-2, and renumbered 4130 in 1901.</dd>
<dt>What it did</dt>
<dd>Per the same source, "the scales are designed for sewer flow design calculations" — consistent with the gravity-flow, slope, and velocity calculations (a Manning's-formula-type computation) typical of sewer rules of the era, though no further formula detail is given.</dd>
<dt>Approx. introduced</dt>
<dd>First shown in the 1897 catalog as the 1749-2; renumbered 4130 in 1901; last mentioned in the 1906 catalog.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from Clark McCoy's K&E catalog site, which documents this model from period catalog scans, not from Jay's own collection, handling, or writing. Treat every detail above as a starting point for research, not settled fact.</p>

<div class="ke-ai-stub-photo" data-hires="/images/ke-rules/ch4-29-4130-colbys-sewer-catalog-full.jpg">

![A 1901 K&E catalog page illustrating the Model 4130 Colby's Sewer Computer](./_images/ch4-29-4130-colbys-sewer-catalog.jpg)

<p class="ke-figure-caption">The Model 4130 Colby's Sewer Computer, from the 1901 K&E catalog. Image courtesy Clark McCoy, mccoys-kecatalogs.com.</p>

</div>

<div class="ke-ai-stub-footer">
<span class="tag">Verify further:</span> <a href="https://www.mccoys-kecatalogs.com/KEModels/ke4130family.htm">Clark McCoy's K&E Catalog Site</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>A 10" sewer-computation slide rule bearing the Crane name, "10" long with paper facings on a wood frame," per Clark McCoy's catalog site, which documents an actual sample photographed from an eBay sale by seller Todd Hughes. First cataloged in 1899 as the 1749-4, renumbered 4132 in 1901. That photographed sample notes the rule "did not have a cursor," and that its accompanying box "is made from a 4058 box turned inside out, however it appears to be original."</dd>
<dt>What it did</dt>
<dd>Per the source, "the scales are designed for sewer flow design calculations" — the same general purpose as the Colby's and Nordell Sewer rules, presumably under a different designer's scale layout or formula approach, though no further formula detail is given.</dd>
<dt>Approx. introduced</dt>
<dd>First shown in the 1899 catalog as the 1749-4; renumbered 4132 in 1901; last appeared in the 1927 hard-bound catalog.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from Clark McCoy's K&E catalog site, which documents an actual sample (eBay sale photos by seller Todd Hughes), not from Jay's own collection, handling, or writing. Treat every detail above as a starting point for research, not settled fact.</p>

<div class="ke-ai-stub-photo" data-hires="/images/ke-rules/ch4-30-4132-cranes-sewer-sample-full.jpg">

![The Model 4132 Crane's Sewer slide rule, front side and case, from an eBay sale photo](./_images/ch4-30-4132-cranes-sewer-sample.jpg)

<p class="ke-figure-caption">The Model 4132 Crane's Sewer, front side and case. Photo by eBay seller Todd Hughes, via Clark McCoy, mccoys-kecatalogs.com.</p>

</div>

<div class="ke-ai-stub-footer">
<span class="tag">Verify further:</span> <a href="https://www.mccoys-kecatalogs.com/KEModels/ke4132family.htm">Clark McCoy's K&E Catalog Site</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>A 20" duplex slide rule bearing the Nordell name, the third member of K&E's Sewer Family alongside the Colby's Sewer and Crane's Sewer. Clark McCoy's catalog site, which documents this model from period catalog scans, describes it as "20" long duplex slide rule with celluloid on a wood frame. The scales are engine divided," and notes that "the first issue of the rule had a clam shell cursor," replaced with an all-glass cursor by the 1915 catalog.</dd>
<dt>What it did</dt>
<dd>Per the source, the scales are "designed for sewer flow design calculations" — the same general purpose as the Colby's and Crane's Sewer rules, presumably under a different designer's scale layout or formula approach, though no further formula detail is given.</dd>
<dt>Approx. introduced</dt>
<dd>First shown in the 1911 slide-rule-only catalog; last mentioned in the 1922 catalog.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from Clark McCoy's K&E catalog site, which documents this model from period catalog scans, not from Jay's own collection, handling, or writing. Treat every detail above as a starting point for research, not settled fact.</p>

<div class="ke-ai-stub-photo" data-hires="/images/ke-rules/ch4-31-4128-nordell-sewer-catalog-full.jpg">

![A 1911 K&E catalog page illustrating the Model 4128 Nordell Sewer slide rule](./_images/ch4-31-4128-nordell-sewer-catalog.jpg)

<p class="ke-figure-caption">The Model 4128 Nordell Sewer, from the 1911 K&E catalog. Image courtesy Clark McCoy, mccoys-kecatalogs.com.</p>

</div>

<div class="ke-ai-stub-footer">
<span class="tag">Verify further:</span> <a href="https://www.mccoys-kecatalogs.com/KEModels/ke4128family.htm">Clark McCoy's K&E Catalog Site</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
...
<p class="ke-figure-caption">An example for use of the Model 4133.</p>
...
![The ultra-rare Model 4091-3 "Special"](./_images/ch4-18-4091-3-spec-rule.jpg)

<p class="ke-figure-caption">The ultra rare Model 4091-3 "Special," shown here courtesy of Clark McCoy.</p>
...
![Nelson Cooke's 1943 letter to the editor of Radio-Craft magazine](./_images/ch4-19-cooke-radio-craft-letter.png)

<p class="ke-figure-caption">- courtesy of ISRM</p>
...
![The back-side numbered scales of the Model 4138 Morrison Radio Engineering rule](./_images/ch4-20-morrison-radio-back-scales.png)

<p class="ke-figure-caption">These scales on the back side are self-documenting, with labels to what each scale involves, shown on the right of each numbered scale.</p>
...
<p class="ke-figure-caption">The National Union Radio Reactance Computer, image courtesy of Richard Smith Hughes, "Specialized Slide Rules for Electronic Engineers," The Oughtred Society.</p>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>The 12" member of K&E's Sector Family, cataloged from 1881 to 1915 in both 6" and 12" varieties. <strong>Note on materials:</strong> Clark McCoy's catalog cross-reference site, which is the only primary source located for this family, lists the material assignment as "4175 ------ 12" Boxwood Sector" and "4176 ------ 12" Ivory Sector" — the opposite pairing from the heading used in this chapter. McCoy's page traces the lineage as: 480 (6" Ivory, 1881) and 481 (6" Boxwood, 1883), converting in 1897&ndash;99 to 1749-7 (12" Boxwood) and 1749-8 (12" Ivory), then in 1901 to 4175 (12" Boxwood) and 4176 (12" Ivory). This summary reports McCoy's pairing as-is rather than assuming either Jay's heading or McCoy's page is the error — that discrepancy is flagged here for future research, not resolved.</dd>
<dt>What it did</dt>
<dd>A "sector" is an older instrument than the slide rule — two hinged rulers etched with proportional scales, used for scaling, proportion, and trigonometric problems by opening the legs to a measured angle, predating the logarithmic slide rule. No K&E-marked physical sample of either sector model is known to exist; McCoy's page documents only catalog page scans.</dd>
<dt>Approx. introduced</dt>
<dd>The 4175/4176 numbering was assigned in 1901 (converted from 1749-7/1749-8); the Sector Family as a whole last appeared in the 1915 catalog.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from Clark McCoy's K&E catalog cross-reference site, which documents this model family from period catalog scans (no physical sample is known to survive), not from Jay's own collection, handling, or writing. Treat every detail above as a starting point for research, not settled fact.</p>

<div class="ke-ai-stub-photo" data-hires="/images/ke-rules/ch4-32-4175-4176-sector-catalog-full.jpg">

![A 1901 K&E catalog page illustrating the 4175 and 4176 Sector rules](./_images/ch4-32-4175-4176-sector-catalog.jpg)

<p class="ke-figure-caption">The 4175/4176 Sector family, from the 1901 K&E catalog. Image courtesy Clark McCoy, mccoys-kecatalogs.com.</p>

</div>

<div class="ke-ai-stub-footer">
<span class="tag">Verify further:</span> <a href="https://www.mccoys-kecatalogs.com/KEModels/ke4175family.htm">Clark McCoy's K&E Catalog Site</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>The 12" companion piece to the 4175 Sector above, cataloged from 1881 to 1915 in both 6" and 12" varieties. <strong>Note on materials:</strong> as flagged in the 4175 entry above, Clark McCoy's catalog cross-reference site — the only primary source located for this family — lists "4176 ------ 12" Ivory Sector," the reverse of this chapter's heading, which pairs 4176 with boxwood. This summary reports McCoy's pairing as-is; the discrepancy between his page and Jay's heading order is unresolved and flagged for future research rather than assumed to favor either side.</dd>
<dt>What it did</dt>
<dd>Functionally identical to the 4175 entry above — a hinged, two-legged proportional instrument for scaling and proportion problems, predating the logarithmic slide rule. No K&E-marked physical sample of either sector model is known to exist; McCoy's page documents only catalog page scans.</dd>
<dt>Approx. introduced</dt>
<dd>The 4175/4176 numbering was assigned in 1901 (converted from 1749-7/1749-8); the Sector Family as a whole last appeared in the 1915 catalog.</dd>
</dl>
...
<div class="ke-ai-stub-photo" data-hires="/images/ke-rules/ch4-33-4175-4176-sector-catalog-full.jpg">

![A 1901 K&E catalog page illustrating the 4175 and 4176 Sector rules](./_images/ch4-33-4175-4176-sector-catalog.jpg)
...
<p class="ke-figure-caption">The earlier Model 101 made of thick, light-colored softwood. Later Model 100 types would be of much thinner redwood. - photo courtesy of eBay</p>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>An 8-foot demonstration rule modeling the Log Log Duplex Deci-Trig scale set of the Model 4081-3, following the same construction approach as its Model 100 and 101 siblings. Clark McCoy's catalog site confirms: "K&E model N105 is a 8 foot version of the 4081-3," and notes that its scale set tracks the general scale changes that happened to the 4081-3 family between 1952 and 1956, meaning field samples may carry three different scale sets depending on when they were made.</dd>
<dt>What it did</dt>
<dd>Per the source, "it was intended to hang on a wall or frame for use in classrooms" — a classroom-scale duplex demonstrator used to teach the 4081-3's log-log/trig scale set to a full room at once.</dd>
<dt>Approx. introduced</dt>
<dd>First shown in the 1952 Educational Products Catalog; renumbered to 68-1923 in 1962; last shown in the 1967 catalog.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from Clark McCoy's K&E catalog site, which documents this model from period catalog scans, not from Jay's own collection, handling, or writing. Treat every detail above as a starting point for research, not settled fact.</p>

<div class="ke-ai-stub-photo" data-hires="/images/ke-rules/ch4-34-n105-demo-catalog-full.jpg">

![A 1962 K&E catalog page describing the Model N105 (68-1923) Log Log Duplex Deci-Trig Demonstration Rule](./_images/ch4-34-n105-demo-catalog.jpg)

<p class="ke-figure-caption">The N105 demonstration rule, from the 1962 K&E catalog. Image courtesy Clark McCoy, mccoys-kecatalogs.com.</p>

</div>

<div class="ke-ai-stub-footer">
<span class="tag">Verify further:</span> <a href="https://www.mccoys-kecatalogs.com/KEModels/keN105family.htm">Clark McCoy's K&E Catalog Site</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
...
![A 1962 K&E catalog page showing the Deci-Lon, Log Log Duplex Decitrig, and Polyphase demonstration rules](./_images/ch4-25-demo-rules-1962-catalog.jpg)

<p class="ke-figure-caption">The 1962 catalog page listing the 68-1929 Deci-Lon, 68-1923 Log Log Duplex Decitrig, and 68-1944 Polyphase demonstration rules by rule length, scale length, front/back scale sets, and body material, alongside the 68-1950 mounting trunnions sold separately for the Deci-Lon and Decitrig models.</p>
...
![The author's 6.5-foot redwood Deci-Lon 10 demonstrator rule hanging in his classroom, front side](./_images/ch4-26-deci-lon-demonstrator-1.jpg)

</div>

<div class="ke-image-feature-item">

![The author's 6.5-foot redwood Deci-Lon 10 demonstrator rule hanging in his classroom, back side](./_images/ch4-27-deci-lon-demonstrator-2.jpg)

</div>

</div>

<p class="ke-image-feature-caption">The author's Model 68-1929 Deci-Lon Demonstrator, a 6.5-foot redwood rule originally from Mineola ISD, hanging on both sides in his classroom today.</p>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>A slide rule "manufactured by K&E for Charles Beseler Company," per Clark McCoy's K&E collection site, which documents an actual sample from the collection of collector Clay Castleberry (scans also provided by Castleberry). The Charles Beseler Company manufactured photo and enlarger supplies, not classroom equipment. The source notes plainly: "This rule is not documented in any K&E literature."</dd>
<dt>What it did</dt>
<dd>Per the source, "it is transparent for use on an overhead projector" — following the same classroom/projection-demonstrator pattern as the Model 68-1960 and 68-1955 overhead-projection rules discussed above, rather than a photographic darkroom calculator. No further detail on its scale set or specific use is given.</dd>
<dt>Approx. introduced</dt>
<dd>Unknown — undated on the documenting source, and absent from all K&E product catalogs.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from Clark McCoy's K&E collection site, which documents an actual sample from the collection of Clay Castleberry, not from Jay's own collection, handling, or writing. Treat every detail above as a starting point for research, not settled fact.</p>

<div class="ke-ai-stub-photo" data-hires="/images/ke-rules/ch4-35-beseler-projection-sample-full.jpg">

![The Beseler Projection Slide Rule, a transparent overhead-projector rule made by K&E for the Charles Beseler Company](./_images/ch4-35-beseler-projection-sample.jpg)

<p class="ke-figure-caption">The Beseler Projection Slide Rule. Photo courtesy Clay Castleberry, via Clark McCoy, mccoys-kecatalogs.com.</p>

</div>

<div class="ke-ai-stub-footer">
<span class="tag">Verify further:</span> <a href="https://www.mccoys-kecatalogs.com/KECollection/beseler_projection/BeselerProjection_1.htm">Clark McCoy's K&E Collection</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
