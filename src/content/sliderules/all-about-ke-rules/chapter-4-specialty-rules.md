...
<p class="ke-figure-caption">A page from the K&E catalog referencing the Model 4160 Chemist's Duplex Rule, dated 1941 - the rule's final catalog year, and as close as this collection comes to a sample, since none has yet been acquired.</p>

</div>

Beyond the Model 4160 itself, K&E's catalogs also list a Model 4165 Urea Index Rule under this same Chemical Family heading. Unlike the 4160, no further description of the 4165 survives in the source material gathered for this chapter - it appears in the historical record as little more than a name and a model number. Rather than guess at its specifics, I'll flag it here as a rule still awaiting research, to be filled in properly once documentation or a sample surfaces.

<div class="ke-clear"></div>

## The Sewer Family

Cataloged alongside the Chemical Family rules, K&E also offered a trio of sewer-grade rules: the 4130 Colby's Sewer, the 4132 Crane's Sewer, and the 4128 Nordell Sewer. As with the Urea Index Rule above, the source material for this chapter preserves only these bare model names and numbers, with no surviving description of their scales, dates, or pricing. They're noted here as members of the family for completeness, with a fuller treatment left for future research.
...
<p class="ke-figure-caption">The detailed illustrations of the Model 4142 Allan Friction Head Duplex in the 1921 catalog - the only trace of this rule I have been able to find.</p>
...
K&E's catalogs list two specific entries under this heading: the 4175 Ivory Sector and the 4176 Boxwood Sector. As with the Urea Index Rule and Sewer Family above, the surviving source material names these two models but preserves no further description of their construction, dating, or pricing history - fitting, given the point Schur raises above about how thoroughly this whole category of rule has vanished from the historical record. They're listed here as a placeholder for future research rather than invented detail.
...
Rounding out the trio, the 8-foot Model N105 modeled the Log Log Duplex Deci-Trig scale set of the Model 4081-3, following the same construction approach as its Model 100 and 101 siblings. As noted above, it was the last of the three to arrive, debuting in the 1952 educational catalog before crossing over into the general 1954 product catalog alongside the Model 100.

<div class="ke-figure">

![A 1962 K&E catalog page showing several demonstration slide rules](./_images/ch4-25-demo-rules-1962-catalog.jpg)

<p class="ke-figure-caption">Demonstration rules from the 1962 slide rule catalog:</p>

</div>

- Model 68-1944 Mannheim Demonstrator — (100) 7 foot 4053 and N4058W demonstration slide rule
- Model 68-1923 Log Log Duplex Deci-Trig Demonstrator — (N105) 8 foot 4081-3 demonstration slide rule
...
Shown only in the 1967 catalog, this overhead-projector version of the Log Log Duplex Deci-Trig (4080/81) rule was made of transparent or translucent material with opaque scales, sized to sit atop a classroom overhead projector. Beyond that single catalog appearance, no further documentation of this rule has surfaced for this chapter.

### Model 68-1955 Deci-Lon Overhead Projection Rule

Its Deci-Log counterpart, the 68-1955 served the same overhead-projector demonstration purpose for the Deci-Lon (68-1100) scale set. As with the 68-1960 above, this is as much as the surviving record currently tells us.

### Beseler Projection Slide Rule

Coming soon. This entry remains a placeholder until further research turns up a fuller history of the rule.
