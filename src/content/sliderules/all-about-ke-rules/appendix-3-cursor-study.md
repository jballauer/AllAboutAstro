---
title: 'Appendix 3: A K&E Cursor Study'
description: A chronological survey of K&E cursor designs, from the earliest all-metal indicators through the glass, celluloid, and unbreakable-plastic generations of the 20th century.
order: 10
draft: false
---
...
This is presently a running timeline rather than a full write-up — as with the rest of this book, expect it to grow into a proper discussion of each design and why K&E moved on from it. In the meantime, see the "K&E Rotting Cursor Syndrome" sidebar in [Chapter 1](/sliderules/all-about-ke-rules/chapter-1-understandings-and-conventions/) for why the celluloid-rail generations of this timeline are the ones to inspect most carefully before buying.
...
- Frameless glass cursor with wooden rails (1926 to 1940)
