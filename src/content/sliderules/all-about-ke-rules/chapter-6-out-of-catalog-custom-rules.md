...
<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from general knowledge of comparable trade-specific custom rules, not from a verified first-hand source or sample. Treat every detail above as a starting point for research, not settled fact.</p>
...
<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from the model's own name and general knowledge of comparable long-scale K&E rules, not from a verified first-hand source or sample. Treat every detail above as a starting point for research, not settled fact.</p>
...
<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from general knowledge of WWII-era U.S. Army artillery computing aids, not from a verified first-hand source or sample. Treat every detail above as a starting point for research, not settled fact.</p>
...
<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from the rule's name alone, not from a verified first-hand source or sample. Treat every detail above as a starting point for research, not settled fact.</p>
...
<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from the rule's name and general knowledge of comparable surveying rules, not from a verified first-hand source or sample. Treat every detail above as a starting point for research, not settled fact.</p>
...
This 20" mahogany rule with a white celluloid face carries the K&E logo stamped on its front, alongside markings for "Chemco Photoproducts Company Ltd, Glen Cove NY" and a "Copyright 1950" date. According to the OS Galleries "Full Details" record for the piece (donated by collector Wayne Harrison), its scale set is **A=B C [P, L]**, used for photography-related calculations: the A and B scales run from 1 to 50, the folded P scale runs from 6 to 300, the folded L scale runs from 14 to 700, and the folded C scale runs from 10 to 100 relative to A and B. OS Galleries rates it "RRRR" — extremely rare, museum-piece territory — and notes that no other mention of the rule turns up in general slide rule references, leaving its exact photographic application unconfirmed.

### American Optical Company

Also absent from any K&E catalog is the **Dr. Prince Refracting Rule**, made by K&E for the American Optical Company. Per the OS Galleries record (donated by collector Clay Castleberry), this is a 48 cm (19") solid boxwood or pearwood rule with no slider — the logarithmic scales themselves do the work, covering age-in-years and dioptric correction on the front with instructions on the back. Manufactured sometime between 1920 and 1950 and rated "RRR" (very rare) by OS Galleries, it was used by opticians for eye examinations before being made obsolete by electronic equipment. Further detail on the rule appears in the *Journal of the Oughtred Society*, Vol. 17, No. 2 (2008), p. 28, "Dr. Prince's Refracting Rule Made by K&E."
