---
title: 'Chapter 6: Out of Catalog, Custom Rules'
description: K&E slide rules that never appeared in a product catalog — the D4053-3 government-issue rule, the Model 4108 Military Rule, the Model 4110 Power Trig "Annapolis Rule," the Belleville Spring Washer Computor, the Brick-O-Meter, and a run of rare custom-industry rules known only by name.
order: 6
draft: false
---
...
<p class="ke-figure-caption">The author's D4053-3 rule, stamped "U.S. LUTZ" — the post-1962 government-resupply version discussed below.</p>
...
<p class="ke-figure-caption">A closer look at the leather case and identification tag of a U.S.-marked D4053-3.</p>
...
<div class="ke-figure" data-hires="/images/ke-rules/ch6-03-american-blueprint-4108-full.jpg">

![The American Blueprint Co. version of the K&E-made Model 4108 Military Rule, shown with its leather case](./_images/ch6-03-american-blueprint-4108.jpg)

<p class="ke-figure-caption">Part of the collection, the American Blueprint Company version of the K&E slide rule, made by K&E.</p>
...
<p class="ke-figure-caption">K&E made the rules, yet the government provided the documentation. Image courtesy of Clark McCoy.</p>
...
<div class="ke-scale-set-row"><span class="ke-scale-set-label">Front side</span><span class="ke-scale-set-scales">Opposite Angle Degs, Opposite Angle Mils [Apex Angle Mils, Apex Angle Degs, CI, C (BASE)] D (RANGE), K</span></div>
<div class="ke-scale-set-row"><span class="ke-scale-set-label">Back of slide</span><span class="ke-scale-set-scales">[TAN, SIN-TAN, SIN, C]</span></div>
<div class="ke-scale-set-row"><span class="ke-scale-set-label">Gauge marks</span><span class="ke-scale-set-scales">π, e, //, /, 785, R</span></div>
...
<p class="ke-figure-caption">The Model 4110 Power Trig — picture courtesy eBay.</p>
...
<div class="ke-figure ke-figure-right" data-hires="/images/ke-rules/ch6-06-belleville-computor-full.jpg">

![The Belleville Spring Washer Computor with its instruction booklet and Associated Spring Corporation leather case](./_images/ch6-06-belleville-computor.jpg)

<p class="ke-figure-caption">The Belleville Spring Washer Computor with its instruction booklet and Associated Spring Corporation case.</p>
...
<div class="ke-scale-set-row"><span class="ke-scale-set-label">Front Side</span><span class="ke-scale-set-scales">Load Flat [OD, OD/ID (2 scales), h/t, E/l-σ²] Thickness</span></div>
<div class="ke-scale-set-row"><span class="ke-scale-set-label">Back Side</span><span class="ke-scale-set-scales">Load Flat [OD, OD/ID (4 scales), h/t, E/l-σ²] Stress</span></div>
...
<div class="ke-figure" data-hires="/images/ke-rules/ch6-07-belleville-front-full.jpg">

![The front side of the Belleville Spring Washer Computor, showing the Load Flat, O.D., and Thickness scales](./_images/ch6-07-belleville-front.jpg)

<p class="ke-figure-caption">Belleville Spring Washer Computor — Front.</p>

</div>

<div class="ke-figure" data-hires="/images/ke-rules/ch6-08-belleville-back-full.jpg">

![The back side of the Belleville Spring Washer Computor, showing the Load Flat, O.D., and Stress scales](./_images/ch6-08-belleville-back.jpg)

<p class="ke-figure-caption">Belleville Spring Washer Computor — Back.</p>
...
<div class="ke-scale-set-row"><span class="ke-scale-set-label">Front side</span><span class="ke-scale-set-scales">Q-Quantity [M-Material, H-Height] L-Length</span></div>
...
<div class="ke-figure" data-hires="/images/ke-rules/ch6-09-brick-o-meter-full.jpg">
...
<p class="ke-figure-caption">The unique Brick-O-Meter in the author's collection.</p>
...
<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from the surrounding narrative (the Brick-O-Meter's construction-trade custom-rule pattern) and general knowledge of comparable rules, not from a verified first-hand source or sample. Treat every detail above as a starting point for research, not settled fact.</p>
...
<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from general knowledge of comparable custom-branded rules, not from a verified first-hand source or sample. Treat every detail above as a starting point for research, not settled fact.</p>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>A K&E-manufactured Mannheim-style rule marked for cash/cost calculations — a photographed sample (via eBay) shows scales labeled "C.B. (A Scale)" and "Cash-Free Cash" on the top and bottom edges, suggesting a proportional cost/quantity rule for the Portland cement trade, in the same spirit as the Brick-O-Meter above.</dd>
<dt>What it did</dt>
<dd>Not explained beyond what the scale labels themselves suggest — cash/cost computations tied to a quantity scale, presumably for pricing cement by volume or weight. Clark McCoy's catalog site, which hosts these photos, offers no further description.</dd>
<dt>Approx. introduced</dt>
<dd>Unknown.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from photos of an actual sample (an eBay-sourced scan hosted on Clark McCoy's K&E catalog site), not from Jay's own collection, handling, or writing. Treat every detail above as a starting point for research, not settled fact.</p>

<div class="ke-ai-stub-photo" data-hires="/images/ke-rules/ch6-15-portland-cement-full.jpg">

![The Portland Cement Slide Rule, a K&E-made cash/cost calculator for the cement trade](./_images/ch6-15-portland-cement.jpg)

<p class="ke-figure-caption">Photo courtesy Clark McCoy, mccoys-kecatalogs.com (originally an eBay sale listing).</p>

</div>

<div class="ke-ai-stub-footer">
<span class="tag">Verify further:</span> <a href="https://www.mccoys-kecatalogs.com/KECollection/PortlandCement/PortlandCement.htm">Clark McCoy's K&E Collection</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>A metal proportional slide rule stamped "REYMOND LEATHER CALCULATOR, Copr. 1923-1925, M.H. REYMOND, Patd. 7-22-1924." A photographed sample shows shoe-size conversion scales — "Youths or Misses," "Boys or G.G.," "Womens," and "Mens" — alongside plain numeric proportional scales, identifying it as a trade rule for the shoe/leather industry rather than tanning generally.</dd>
<dt>What it did</dt>
<dd>Likely used to convert or compute leather material needs or costs across the different shoe-size systems shown on its scales, though the exact computation isn't explained in the source photos.</dd>
<dt>Approx. introduced</dt>
<dd>Copyright 1923-1925, patented July 22, 1924, per the markings on the rule itself — though it's unconfirmed whether K&E manufactured it outright or simply produced it under M.H. Reymond's patent, similar to how K&E built rules under license for the Kells/Kearn/Bland and Thacher/Stanley patents discussed elsewhere in this book.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from photos of an actual sample (an eBay sale scanned by seller Richard Spooner in September 2003, hosted on Clark McCoy's K&E catalog site), not from Jay's own collection, handling, or writing. Treat every detail above as a starting point for research, not settled fact.</p>

<div class="ke-ai-stub-photo" data-hires="/images/ke-rules/ch6-12-reymond-leather-calculator-full.jpg">

![The Reymond Leather Calculator's shoe-size scales, marked Youths or Misses, Boys or G.G., Womens, and Mens](./_images/ch6-12-reymond-leather-calculator.jpg)

<p class="ke-figure-caption">Photo courtesy Clark McCoy, mccoys-kecatalogs.com (originally an eBay sale, September 2003, scans by Richard Spooner).</p>

</div>

<div class="ke-ai-stub-footer">
<span class="tag">Verify further:</span> <a href="https://www.mccoys-kecatalogs.com/KECollection/ShortBase/ReymondLeather/keReymondLeather.htm">Clark McCoy's K&E Collection</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>A 20" variant of the 4053-5 Mannheim style, nicknamed the "20" Mystery Slide Rule" by researcher Clark McCoy. Known samples (serial numbers 044178, 044071, and an unmarked one at 925411, from the Ron Knapp and Tom Wyman collections) show the L scale moved to the front of the rule — displacing the K scale to the front edge, as on pre-1922 4053s — plus a second A scale added between the S and T scales on the back of the slide, with the S and T scales referenced to decimal degrees rather than the usual degrees/minutes/seconds. The 4104 model number is not referenced in any K&E catalog.</dd>
<dt>What it did</dt>
<dd>Not explained directly, but the decimal-degree trig scales mirror the pattern of the D4053-3 government rule discussed earlier in this chapter, suggesting a military application.</dd>
<dt>Approx. introduced</dt>
<dd>Based on serial number, case, and cursor style, either 1945-46 or 1955-56, depending on which of K&E's serial-number rollovers applies.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from Clark McCoy's K&E catalog site, which documents actual samples (from the Ron Knapp collection, scans by Ron Knapp), not from Jay's own collection, handling, or writing. Treat every detail above as a starting point for research, not settled fact.</p>

<div class="ke-ai-stub-photo" data-hires="/images/ke-rules/ch6-10-4104-mystery-rule-full.jpg">

![The K&E Model 4104, a 20" Mannheim variant nicknamed the Mystery Slide Rule, showing its A, B, C, L, D scale set](./_images/ch6-10-4104-mystery-rule.jpg)

<p class="ke-figure-caption">Photo courtesy Ron Knapp, via Clark McCoy, mccoys-kecatalogs.com.</p>

</div>

<div class="ke-ai-stub-footer">
<span class="tag">Verify further:</span> <a href="https://www.mccoys-kecatalogs.com/KECollection/4104/ke4104_1.htm">Clark McCoy's K&E Collection</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
...
<p class="ke-ai-stub-desc">This summary was generated by an AI assistant without being able to read the linked source article, not from a verified first-hand source or sample. Treat every detail above as a starting point for research, not settled fact.</p>

<div class="ke-ai-stub-media">catalog image not yet sourced</div>

<div class="ke-ai-stub-footer">
<span class="tag">Verify further:</span> <a href="https://osgalleries.org/journal/displayarticle.cgi?match=6.1/V6.1P25.pdf">Journal of the Oughtred Society, V6.1 p.25</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>An 18¼" x 2¾" mahogany Mannheim-style rule with three interchangeable slides for different guns and calculation types, a C and D scale, and a 1943 date stamped on the rule itself. The scales (15¾" long) are screened onto painted wood rather than engraved. Clark McCoy's catalog site, which documents an actual sample, labels it simply "Graphical Firing Table Slide Rule" — it isn't confirmed here whether that sample specifically corresponds to the "M4" and "M16" designations in Jay's working list, or to other graphical-firing-table variants K&E may have produced.</dd>
<dt>What it did</dt>
<dd>Field-artillery firing-table calculations — the three slides suggest support for multiple gun types or firing scenarios, consistent with general WWII U.S. Army graphical firing table practice.</dd>
<dt>Approx. introduced</dt>
<dd>1943, per the date stamped on the documented sample.</dd>
</dl>
...
<div class="ke-ai-stub-photo" data-hires="/images/ke-rules/ch6-11-graphical-firing-table-full.jpg">

![The K&E Graphical Firing Table slide rule, a WWII-era artillery computation aid dated 1943](./_images/ch6-11-graphical-firing-table.jpg)
...
<div class="ke-ai-stub-footer">
<span class="tag">Verify further:</span> <a href="https://www.mccoys-kecatalogs.com/KECollection/GraphicalFiring/K&E_GF_1.htm">Clark McCoy's K&E Collection</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
...
<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from general knowledge of the well-documented E-6B design, not from a verified first-hand source or sample of K&E's specific version. Treat every detail above as a starting point for research, not settled fact.</p>
...
<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from the rule's name and general knowledge of comparable trade-specific custom rules, not from a verified first-hand source or sample. Treat every detail above as a starting point for research, not settled fact.</p>
...
<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from the rule's name and general knowledge of comparable medical calculators, not from a verified first-hand source or sample. Treat every detail above as a starting point for research, not settled fact.</p>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>A 10" TimeSlide Calendar Slide Rule, stamped "MADE IN U.S.A. BY KEUFFEL &amp; ESSER CO." A photographed sample shows month-by-month date scales (November/December visible) paired with a percentage scale (5% to 25%) — Clark McCoy's catalog site, which documents the sample, doesn't connect it to an "Albert J. Smith" name, which appears to be from Jay's own research elsewhere (possibly the rule's designer or patent holder).</dd>
<dt>What it did</dt>
<dd>The paired date and percentage scales suggest a rule for computing calendar-based interest, discount, or elapsed-time percentages, though the exact use isn't explained in the source photos.</dd>
<dt>Approx. introduced</dt>
<dd>Unknown — the documented sample was photographed from an eBay sale in November 2002, which dates the photos, not the rule's original production.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from Clark McCoy's K&E catalog site, which documents an actual sample, not from Jay's own collection, handling, or writing. Treat every detail above as a starting point for research, not settled fact.</p>

<div class="ke-ai-stub-photo" data-hires="/images/ke-rules/ch6-14-timeslide-calendar-full.jpg">

![The K&E TimeSlide Calendar Slide Rule, showing November/December date scales and a percentage scale](./_images/ch6-14-timeslide-calendar.jpg)

<p class="ke-figure-caption">Photo courtesy Clark McCoy, mccoys-kecatalogs.com (originally an eBay sale, November 2002).</p>

</div>

<div class="ke-ai-stub-footer">
<span class="tag">Verify further:</span> <a href="https://www.mccoys-kecatalogs.com/KECollection/CalendarSlideRule/CalendarSlideRule.htm">Clark McCoy's K&E Collection</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>A 20" Mannheim-type rule that Clark McCoy's catalog site — which documents an actual sample from his own collection — labels a "Military Special," used for short-base triangulation surveying (computing distances without a long measured baseline), related in purpose to the Stadia Family of rules covered in Chapter 4.</dd>
<dt>What it did</dt>
<dd>Not explained beyond the "Military Special" designation and its 20" Mannheim scale layout.</dd>
<dt>Approx. introduced</dt>
<dd>Unknown — not dated on the documenting source.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from Clark McCoy's K&E catalog site, which documents an actual sample from his own collection, not from Jay's own collection, handling, or writing. Treat every detail above as a starting point for research, not settled fact.</p>

<div class="ke-ai-stub-photo" data-hires="/images/ke-rules/ch6-13-short-base-triangulation-full.jpg">

![The K&E Short Base Triangulation Slide Rule, a 20" Mannheim-type military special for surveying](./_images/ch6-13-short-base-triangulation.jpg)
...
<div class="ke-ai-stub-footer">
<span class="tag">Verify further:</span> <a href="https://www.mccoys-kecatalogs.com/KECollection/ShortBase/keShortBase_1.htm">Clark McCoy's K&E Collection</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
...
<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from the model number and general knowledge of K&E's numbering conventions, not from a verified first-hand source or sample. Treat every detail above as a starting point for research, not settled fact.</p>
...
<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from the OS Galleries "Full Details" database record for this item (donated by collector Wayne Harrison, rated "RRRR" — extremely rare), not from Jay's own collection, handling, or writing. Treat every detail above as a starting point for research, not settled fact.</p>

<div class="ke-ai-stub-media">catalog image not yet sourced</div>

<div class="ke-ai-stub-footer">
<span class="tag">Verify further:</span> <a href="https://osgalleries.org/os/fulldetails.cgi?match=404">OS Galleries record</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
...
<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from the OS Galleries "Full Details" database record for this item (donated by collector Clay Castleberry, rated "RRR" — very rare), not from Jay's own collection, handling, or writing. Treat every detail above as a starting point for research, not settled fact.</p>

<div class="ke-ai-stub-media">catalog image not yet sourced</div>

<div class="ke-ai-stub-footer">
<span class="tag">Verify further:</span> <a href="https://osgalleries.org/os/fulldetails.cgi?match=374">OS Galleries record</a> &middot; <a href="https://www.oughtred.org/">The Oughtred Society</a> &middot; <a href="https://www.sliderulemuseum.com/">International Slide Rule Museum (ISRM)</a>
</div>
