...
<dt>What it is</dt>
<dd>K&E's own in-house pocket-watch slide rule, introduced in 1908 as the direct successor to the imported Boucher Calculator discussed above — the first pocket-watch rule K&E manufactured itself rather than imported.</dd>
<dt>What it did</dt>
<dd>Not described anywhere in the surviving source material beyond its role as the Boucher's replacement. Presumably it functioned like the other pocket-watch rules in this chapter, with rotating scales on a watch-style dial for multiplication, division, and proportion.</dd>
<dt>Approx. introduced</dt>
<dd>1908, per Jay's own account above. A Hopp price-and-availability table for pocket-watch rules (reproduced earlier in this section) lists a Model 4016 beginning in the mid-1900s that may correspond to this rule, though that identification is not confirmed here.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from the surrounding narrative and general knowledge of comparable pocket-watch rules, not from a verified first-hand source or sample. Treat every detail above as a starting point for research, not settled fact.</p>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>K&E's second in-house pocket-watch rule, introduced in 1909 — following the Sperry Calculator and completing K&E's transition away from imported Boucher/Calculigraphe designs.</dd>
<dt>What it did</dt>
<dd>Not described anywhere in the surviving source material beyond its introduction date. Likely functioned similarly to the Sperry Calculator and the Boucher/Calculigraphe rules it ultimately replaced.</dd>
<dt>Approx. introduced</dt>
<dd>1909. The same Hopp price table referenced above lists two further model numbers, 4017 and 4018, appearing in the years after the Sperry's debut and continuing into the 1930s&ndash;40s, which may correspond to this rule across its production run.</dd>
</dl>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>A specialty rule cataloged by K&E within the 41XX series used for linear specialty rules, alongside the Model 4180 Fraction Adder and Model 4185 Brunton Slope Chart discussed below.</dd>
<dt>What it did</dt>
<dd>The name points to a psychrometric-calculation rule — computing relative humidity, dew point, or related air-moisture properties from wet-bulb and dry-bulb thermometer readings, a common HVAC and meteorological task. "Kurtz" most likely names the rule's designer or licensor, following the same convention as the Kissam Stadia, Roylance, and Hudson rules discussed earlier in this book.</dd>
<dt>Approx. introduced</dt>
<dd>Unknown — no catalog appearance has been confirmed for this chapter.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from general knowledge of comparable specialty slide rules, not from a verified first-hand source or sample. The surviving record for this chapter contains only the model's name and number — treat every detail above as a starting point for research, not settled fact.</p>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>Not to be confused with the Merchant's Family's wood-bodied Model N4096 Desk rule or Model 4096M covered in Chapter 4 — this is a distinct, very early all-metal Mannheim-format rule. Chapter 4 itself flags the distinction in advance: "this rule is not to be confused with a very early All-Metal Mannheim Model 4096, a rule we will discuss toward the end of our text&hellip; It is an absolute unicorn."</dd>
<dt>What it did</dt>
<dd>Presumably a standard Mannheim scale set (A, B, C, D at minimum) executed in metal rather than K&E's usual celluloid-covered wood — the material choice alone would have made it a very early, and very unusual, K&E product.</dd>
<dt>Approx. introduced</dt>
<dd>Unknown — no catalog appearance or date has survived in the source material for this chapter.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from general knowledge of comparable specialty slide rules and the forward-reference already written in Chapter 4, not from a verified first-hand source or sample. Treat every detail above as a starting point for research, not settled fact.</p>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>Cataloged within the same rare-linear-rule numbering block as the 4175 Kurtz Psychrometric above and the 4185 Brunton Slope Chart below.</dd>
<dt>What it did</dt>
<dd>The name suggests a device dedicated to adding and computing with fractions rather than decimals — likely aimed at trades such as carpentry or machining that routinely work in fractional inches. Whether it took the form of a conventional slide rule or a more specialized mechanical adder is not established in the surviving source material.</dd>
<dt>Approx. introduced</dt>
<dd>Unknown — no catalog appearance has been confirmed for this chapter.</dd>
</dl>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>Cataloged within the same rare-linear-rule numbering block as the 4175 Kurtz Psychrometric and 4180 Fraction Adder above.</dd>
<dt>What it did</dt>
<dd>"Brunton" most likely references the Brunton compass (pocket transit), a standard surveying and geology instrument for measuring bearing and inclination. A "slope chart" built around it would most plausibly convert angle-of-inclination readings into grade or slope percentages — a close cousin to the reduction work performed by the Stadia Family rules covered in Chapter 4.</dd>
<dt>Approx. introduced</dt>
<dd>Unknown — no catalog appearance has been confirmed for this chapter.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from general knowledge of comparable specialty slide rules and this chapter's own Stadia Family discussion, not from a verified first-hand source or sample. Treat every detail above as a starting point for research, not settled fact.</p>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>A specialty item cataloged under the 40XX numbering rather than the 41XX linear-specialty block used by the other rare rules in this section, grouped here nonetheless as a stand-alone, one-off product.</dd>
<dt>What it did</dt>
<dd>"Mathematical Chart" suggests this was more nomograph than slide rule — a printed alignment chart rather than a scaled, sliding instrument, similar in spirit to some of K&E's other licensed specialty products. "Goodchild" most likely names the chart's designer or licensor.</dd>
<dt>Approx. introduced</dt>
<dd>Unknown — no catalog appearance has been confirmed for this chapter.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from general knowledge of comparable specialty slide rules and charts, not from a verified first-hand source or sample. The surviving record for this chapter contains only the model's name and number — treat every detail above as a starting point for research, not settled fact.</p>
...
<dl class="ke-ai-stub-facts">
<dt>What it is</dt>
<dd>Uncertain, and flagged here honestly rather than invented: no model number survives for this entry anywhere in the source material, which is unusual for this book — every other device in this chapter carries at least a catalog number. It's plausible this isn't a named slide rule model at all, but a general catalog term K&E used for a mechanical adding/calculating device they distributed rather than manufactured or divided in-house.</dd>
<dt>What it did</dt>
<dd>If it follows the pattern of other mechanical (non-slide-rule) devices K&E distributed, most likely a geared adding machine for basic arithmetic rather than a logarithmic computing device.</dd>
<dt>Approx. introduced</dt>
<dd>Unknown — no catalog appearance, date, or even a model number has survived in the source material for this chapter.</dd>
</dl>

<p class="ke-ai-stub-desc">This summary was generated by an AI assistant from general pattern-matching only, not a verified first-hand source or sample — this is the thinnest entry in the chapter, preserving only a bare name. Treat every detail above as a starting point for research, not settled fact.</p>
