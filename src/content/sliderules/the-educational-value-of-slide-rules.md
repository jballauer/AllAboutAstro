...
Here's another example where using a slide rule has significant educational value. Consider the computation 367 × 12. Setting up the slide rule is pretty straight-forward. Students of the day would align the decimals 3.67 and 1.2 using the C and D scales. Most any slide rule would compute the three significant digits of 440. The arithmetic would obviously place the decimal at 4.40, but that's not the correct magnitude for the answer. So how many places should the decimal move?

This is where students of yesteryear would have known inherently something that today's students struggle with, namely, scientific notation. They would have mentally constructed 367 as 3.67 × 10² and 12 as 1.2 × 10¹. As such, they would have known, when multiplying those numbers, that the product of same-base exponentials adds the powers: 10² × 10¹ = 10³. So the answer of 4.40 × 10³ would have told the student to drag the decimal to the right three places, yielding approximately 4400 as a result (we must apply the last zero).
...
<p class="ke-figure-caption">Comparing tangent to sine in this interval, the curves are approximate to within three significant figures.</p>
...
*Note: For those needing a quick reminder, the log of a number is the value required to raise a base, in this case base 10, to yield the argument (the number in parentheses). Said as an exponential, 10^.477 = 3 in the following example.*
...
![A K&E GP-12 slide rule showing a logarithmic scale and a linear scale](./_images/edu/edu-12.jpg)

<p class="ke-figure-caption">This is a special K&E (Keuffel & Esser) GP-12 slide rule that demonstrates the use of a logarithmic scale (top) and a linear scale (bottom) to discover the mantissa of a log. This rule aligns the input 3 on the top scale, with the logarithm output on the bottom scale, reading approximately 0.477 (note the use of 0.0 to 1.0, equally spaced). To compute log (30), the same setting is used, except that the user knows to add 1 to this 0.477 value.</p>

</div>

<div class="ke-figure">

![A basic K&E slide rule showing the L scale for base 10 logs](./_images/edu/edu-13.jpg)

<p class="ke-figure-caption">Almost all slide rules have a base 10 log scale, often labelled "L." Note we see it here on one of K&E's more basic slide rules. The scale runs left to right in the middle of the slide rule, with the L label on the right. The input would be set on the "D" scale in this case. Note again, reading at the hairline of the cursor, the value of ~0.477.</p>
...
![A Covid case chart with a linear y-axis](./_images/edu/edu-14.png)

</div>

<div class="ke-figure">

![A Covid case chart with a logarithmic y-axis](./_images/edu/edu-15.png)
...
![A slide rule scale set illustrating discovery of the A, K, and D scales](./_images/edu/edu-22.jpg)

</div>

<div class="ke-image-feature-item">

![A slide rule scale set illustrating discovery of the A, K, and D scales](./_images/edu/edu-23.jpg)

</div>

<div class="ke-image-feature-item">

![A slide rule scale set illustrating discovery of the A, K, and D scales](./_images/edu/edu-24.jpg)
...
![A close-up of a slide rule scale showing tick-mark resolution, including pi and e gauge marks](./_images/edu/edu-25.jpg)

</div>

It takes practice to be able to read a slide rule at first, just because we are not used to seeing decimals represented in this way. But this exercise alone, simply moving the hairline of the cursor to random numbers called out in class can give students a firm understanding of the scale and precision represented by decimal numbers out to several figures. Similarly, you might have noticed additional marks on the scale above, including π ≈ 3.14 and e ≈ 2.72? These can also be represented to students as a good visual of those values relative to others. Similarly, a teacher could have students put their own custom values on the scale (often called "gauges"). For example, some square roots like √2, √3, and √10 routinely come up in class whereas a decimal equivalence can be useful when memorized. Even with a paper copy of the above scale, having students point out a variety of decimals to the hundredth's place will pay dividends. Then having them find 1.41, 1.73, and 3.16 and labeling them with the above square roots respectively, not only will there be a better sense of the placement of these values compared to their integer arguments, but they can discover first hand how closely approximate the square root of 10 actually is to π!\*
...
Thus, with one setting of the slide, you have computations for 8 ÷ 5 = 1.6 and 5 ÷ 8 = .625, which are also the decimal reciprocals of those values. Important to note that those same values are the quotient for ANY two numbers opposing each other on the C and D scales. So, 2 on the C and 3.2 on the D can be related as 3.2 ÷ 2 = 1.6, or 2 ÷ 3.2 = .625. Thus, we see a setting of the rule for ALL ratios that equate to either 1.6 or 0.625. Again, this is for any aligned pairing of numbers, such as 2.5 and 4; 3 and 4.8; and even 40 and 64, considering that a number like "4" on a scale also represents 40 or 400 or 0.400, if you are so inclined.
...
...whereas under the cursor the "1" or "left-index" of the C scale is set over the 1.9 mark on the D scale. From there, all aligned numbers would represent fractions equivalent to 1.9 when reading the D scale over the C scale. Quickly here, 2.85 / 1.5 and 3.8 / 2, or even 475 / 250.
...
Note that 22/7 is usually given by many teachers as a rational number approximation for pi. We see it here clearly on the slide rule!

Oh, and if it is helpful, 710/226 approximates pi correctly up to 3.141592. That is 8-significant figures if you aren't counting. Give that one a try on your slide rule!

This gives you an idea of the usefulness of the "folding scales" like CF and DF. Having the index in the center of the rule, it assure that there are no "off-the-rule" computations when using the wrong index on the normal scales. Similarly, because the scale is folded at pi, then you always have the product of n × π, IF n is on the D scale and the product is read off the DF scale (no movement of the slide is necessary). As such, this makes quick work of computations involving the circumference and area of circles.

*\*Historical Note: Because √10 is so close to π, many slide rules from other makers began their folded scales at the square root of 10 instead of pi.*
...
____ × ____ = 16, with the understanding that the numbers in the blanks had to be the same number (thinking of the length and width required to make a "square"). And after recalling their 3rd grade multiplication tables, would have realized that 4 × 4 was the multiplication that yielded a 16. Now, note the image below:

<div class="ke-figure ke-figure-right">

![An Aristo Darmstadt slide rule with the slide removed, D scale set to 4 and A scale reading 16](./_images/edu/edu-29.jpg)
...
![A slide rule's P scale, self-documented for Pythagorean relationships](./_images/edu/edu-30.jpg)

</div>

<div class="ke-figure">

![A right triangle diagram](./_images/edu/edu-31.jpg)
...
<p class="ke-figure-caption">Where circled, we divide the 9 by 14 (ignore the decimal in 1.4), the result being read under the left index of the C scale (see under the hairline). However, we do not need this figure (0.642). Instead, we read the bottom, red P scale for the value 0.766. By dividing with the hypotenuse (14), we now have corresponding leg values when the hypotenuse is 1.</p>
...
sin² x + cos² x = 1, where x is in degrees.
...
![The K&E Deci-Lon 5 slide rule's LL scales](./_images/edu/edu-34.jpg)

<p class="ke-figure-caption">With the K&E Deci-Lon 5 slide rule, the bottom four scales represent one continuous scale for the base of exponentials, beginning at 1.001 on the Ln 0 scale and running to 30,000 on the Ln 3 scale. Flipping the slide rule over reveals Ln-0 to Ln-3 scales for bases between .999 to .00003.</p>

</div>

<div class="ke-figure">

![The Pickett NP4-ES slide rule's LL scales](./_images/edu/edu-35.jpg)

<p class="ke-figure-caption">With the Pickett NP4-ES, the scales are implemented differently, with LL1 and LL2 on the top rail and LL3 and LL4 on the bottom, with values above 1 in black numbers and values below 1 in red running "back-to-back" on the same scale.</p>
...
![The Aristo StudioLog 0969, a massive desk model slide rule](./_images/edu/edu-36.jpg)
...
![The Aristo StudioLog 0969 with the slide removed, showing e on the LL3 scale](./_images/edu/edu-37.jpg)

<p class="ke-figure-caption">Figure 1 - With the slide removed, the number e (on LL3) is the base of an exponential with 1 (on D) aligned above it, circled. The value is read off of the same LL3 scale. As such, e¹ = e. Note that here, e raised to any power can be computed, as under the hairline we have e³ ≈ 20 (20.085 with calculator).</p>

</div>

<div class="ke-figure">

![The Aristo StudioLog 0969 with the right index of C aligned to 2.0 on LL2](./_images/edu/edu-38.jpg)

<p class="ke-figure-caption">Figure 2 - Here, we have the rule set at the hairline with the right index (10) of the C scale aligned with 2.0 on the LL2 scale. From this setting, any power with base 2 can be seen on the rule, with the input on the C scale (in yellow) and the answer read off the LL3 scale. In the circled areas, from left to right, we see 2, 3, 4, and 5 on the C scale with outputs on LL2 as 4, 8, 16, and 32 respectively.</p>

</div>

</div>

The implication of this should be obvious. If used in a fixed position without the slide, then the position of the cursor on D (which is identical to C), shows the value of base e raised to any power. Once we add the slide back, we could set the index of C to any base of our choice (on any of the LL scales) and place the hairline on any exponent on that C scale. The result will be read off the same LL scale where the base was set, unless the right index is used and you would read the output off of the scale above it for bases larger than one and below it for bases less than 1.
...
And then, just as division can be performed on the rule due to being the inverse of multiplication, so can logarithms of any base. For example, for a problem like x = log₂ 4.5, the student can set 2 on the LL2 scale as usual, move the hairline to 4.5 on the LL3 scale, and then read the correct answer off of the C scale (exactly the opposite of doing the exponential). This also reinforces the definition of the log itself, meaning that each time a student solves a log equation, the student is reminded exactly what a "log" is, as the word sentence, "2 to what power is 4.5," is visibly shown on the slide rule.

This only scratches the surface of understanding for students. Slide rules require students to develop a need for math properties to solve certain problems. For example, while a calculator can handle something like log (.041), the slide rule has difficulty with this without a little bit of rethinking. This is because the LL1 scale (where the base 10 is) and the LL03 scale (where .041 is) cannot be used simultaneously like we did in the previous paragraph. So students of the era knew that when taking the log (x) when x is between 0 < x < 1, the problem had to be rewritten. For example, the argument of the log above, .041, could be expressed as a product of 4.1 × 10⁻², whereas the "Product Rule of Logs" allows for log (4.1) + log (10⁻²). Because log (10⁻²) = -2, which is something students of the past would have known without using the "power rule" for logs, then the result can be found by computing -2 + log (4.1). Students could use either the L scale or the LL3 scale to compute the log portion (see Figures 3 to 5 below). And, of course, this was also a good way to get students some practice with scientific notation!
...
![A Post/Hemmi 1441 slide rule set to compute log(4.1)](./_images/edu/edu-39.jpg)

<p class="ke-figure-caption">Figure 3 - With the index of C set to 4.1 on the D scale, this cute Post/Hemmi 1441 slide rule is setup to compute log(4.1). The solution will be found on the back of the rule in Figure 4. Of special note is the magnifying cursor, which many makers used on rules that are otherwise too small to read.</p>

</div>

<div class="ke-figure">

![The back of the Post/Hemmi 1441 slide rule, showing the L scale](./_images/edu/edu-40.jpg)

<p class="ke-figure-caption">Figure 4 - Many rules like this have scales on the back of the slide. Here, the middle L scale is for base 10 logs. The result is read off of the red hairline on the small back window, 0.613 as shown here. For basic rules without Log Log scales, log problems always have to be converted to base 10 using the "change of base" rule. If the problem is already base 10, yet for arguments less than 1, then other log rules will apply, by necessity.</p>
...
![A Post 1461 Versalog slide rule set up on the Log Log scales to compute log(4.1)](./_images/edu/edu-41.jpg)

<p class="ke-figure-caption">Figure 5 - Despite being a base 10 problem, the log(4.1) can be found with the Log Log scales, as shown here on this Post 1461 Versalog, which is the more powerful, bigger brother to the Post 1441. We see the index of C setup on the 10 of the LL3 scale (circled). The hairline is set to 4.1, also on LL3. The resulting .613 value, read off the C scale, would add to -2 in the problem, log (.041) = log (10⁻²) + log (4.1) = -2 + .613 ≈ -1.37.</p>
...
![The Hemmi 257 Chemical Engineering slide rule](./_images/edu/edu-42.jpg)

<p class="ke-figure-caption">Hemmi 257 Chemical Engineering - This slide rule serves a special purpose, as can be seen by the nature of the scale set. Gone are the typical C/D and A/B general math scales, replaced by scales to help chemists. Today's Chemistry teachers would not know that such slide rules exist. Most other disciplines that we teach have analogous slide rules as well.</p>
...
The classic example is doing the computation (3 × 4 × 5) / (6 × 7), simplified here to whole numbers for demonstration purposes. There is danger when doing this computation with a calculator, as students will typically multiply the entire numerator, followed by dividing the denominator. But as we know, if the parentheses are not honored in the denominator, then the 7 can easily end up being multiplied rather than being divided with the 6.

With the slide rule, if the numerator is multiplied first, followed by the denominator, then those intermediate values will need to be written down prior to finding the final quotient. But there's a trick...students of yesteryear would have known to work the problem as 3 ÷ 6 × 4 ÷ 7 × 5, in that order. This chaining of operations, which is totally permissible, allows the results of the each step to be used directly into the next operation, all without ever needing to use paper.

Important for us, and today's students, is that you would never have reason to handle the problem that way, and so students would likely not ever know that doing so was possible, and in many instances both safe and useful. In this case, the parentheses "serve" the problem, yet I find that students will almost always perform the parentheses quite literally. As such, they think of the computation as 60 / 42.

<div class="ke-figure ke-figure-right">

![The Faber-Castell 2/83 N Novo-Biplex slide rule](./_images/edu/edu-43.jpg)

<p class="ke-figure-caption">Pictured is the Faber-Castell 2/83 N Novo-Biplex, regarded as one of the most beautiful and powerful slide rules ever produced. Note here the right hand side of the scales are labeled with the functions they perform. This feature was known as "self-documenting." It was mostly a European feature. Click on the image to see a close-up.</p>

</div>

<div class="ke-figure ke-figure-left">

![A slide rule with the slide removed, set to find the outputs of 2.2](./_images/edu/edu-44.jpg)

<p class="ke-figure-caption">With the slide removed because it's not needed here, this rule is set to find the outputs of 2.2. Reading closely, the square of 2.2 is on the A scale, the cube of 2.2 is on the K scale, and the log of 2.2 is on the L scale. These values can be read to three significant figures as 4.84, 10.6, and .342 respectively. Moving the hairline lets you quickly read-off these values for any number you desire.</p>

</div>

Fact of the matter is, with fractions composed entirely of monomials, numbers (or factors) on top can be multiplied and numbers on bottom can be divided. While this sounds insignificant, in practice it means something quite powerful to students. I discovered this long ago when teaching transformations of trig graphs, watching students struggle when they are instructed to divide "B" values to the function's inputs. So when they are faced with π/2 ÷ 2, they almost always fail to understand that all they need to do is place the 2 on the bottom - anything on the bottom is divided - leaving π/4. Instead, I watch students reciprocate the 2 and then multiply, almost without exception.
...
Another example of when the slide rule makes you rethink math is what happens when you multiply something like 4.2 × 6.7. It requires using the right index on the C scale to get the correct result; however, the inclination is to use the left index first, which would put the solution off the slide rule. To fix this, you either have to remember to use the right index OR you use an inverse (CI) scale and treat the problem like it's a division problem, because multiplying two numbers is the same as dividing by its inverse, something that would have been common knowledge in the slide rule era.
...
The concept of factoring begins early, around the 5th or 6th grade, as students first learn that numbers can be written into products. In first use, a number can be expressed as its "prime factors." As example, the number 20 in its prime factored form would be expressed as 2 × 2 × 5. This idea of turning a number into a product of smaller values has important implications for reducing fractions, since if both the numerator and denominator are broken into their prime factors, then the fraction might be reducible. That could be shown with something like 12/20 = (2 × 2 × 3) / (2 × 2 × 5) = 3/5. All the twos would cancel each other here.

This idea of "forming a product" is key to factoring at higher levels, such as for factoring a math expression. So, for something like 2x² + 8x, a product can be formed by pulling the greatest common factor (GCF) - or any factor really - typically learned first around 7th or 8th grade. In our example, 2x² + 8x = 2x (x + 4). Note that what is left is a product of 2x and (x + 4).
...
![A DIY addition rule made with two linear scales](./_images/edu/edu-45.jpg)

</div>

<div class="ke-image-feature-item">

![The DIY addition rule computing 22 + 45](./_images/edu/edu-46.jpg)

</div>

<div class="ke-image-feature-item">

![The DIY addition rule computing 422 + 391](./_images/edu/edu-47.jpg)

</div>

<div class="ke-image-feature-item">

![The DIY addition rule computing 714 + 847 using the right index](./_images/edu/edu-48.jpg)

</div>

</div>

<p class="ke-image-feature-caption">Figure 1 - A DIY Addition Rule made with two linear scales to perform addition and subtraction. Note that each inch is divided into tenths, not the typical standard U.S. or British imperial measurement. Figure 2 - Our slide rule here is setup to compute something easy, like 22 + 45. Clearly the linear distances add quite easily to yield the sum of 67 on the upper rule. Subtraction is of course the opposite, where the two numbers to be subtracted are aligned over each other and the difference taken off of the left index. Figure 3 - Performing 422 + 391 from the factoring method above, our slide rule gives an approximate sum of 813, with a little imagination. A lack of precision with this hand-drawn rule not withstanding, the method remains instructive. Figure 4 - When the sum has "carry-over" digits, spilling into a 4 digit sum, the right index can be used just as with our regular slide rule. Here, the DIY rule is setup to compute 714 + 847 by aligning 714 up with the right index of the bottom scale. Borrowing a glass cursor from a real slide rule, you can see the sum on the hairline of the top scale. Of course, students would need to know to add another digit to the computation when the right index is used like this.</p>
...
Precision can come into question with our DIY Addition Rule. In Figure 3, we show the setup for 422 + 391, as we computed in the previous method. The sum of 813 can be shown once again with my make-shift cursor.

Finally, we answer the question you might have wondered, "How does it work for answers that go off the slide rule?" And just like a regular slide rule, we can simply use the RIGHT index (10) to do such computations. Working out a sum like 714 + 847 in Figure 4, I have aligned the right index of the bottom scale with the value of 714 on the top scale. Using a cursor glass from a real slide rule, I set the hairline on 847 on the bottom scale, reading the sum of ~1560 from the top scale. Here, you would have to know to read the top scale as 1560, and not 560. 4 significant figures of precision is a difficult ask for a DIY rule such as this, since the actual sum is 1561, but it's easy to be amused at what can be accomplished with couple of quickly drawn scales like this. And for sums no larger than three digits, this method is surprisingly accurate.
...
![The Faber-Castell 67/54 RB Darmstadt slide rule side](./_images/edu/edu-49.jpg)

<p class="ke-figure-caption">Faber-Castell 67/54 RB Darmstadt - Showing off its slide rule side.</p>

</div>

<div class="ke-figure">

![The Faber-Castell 67/54 RB Darmstadt Addiator side](./_images/edu/edu-50.jpg)

<p class="ke-figure-caption">Faber-Castell 67/54 RB Darmstadt - Showing off its Addiator side.</p>
...
Another option, beyond the DIY slide rule activities in my article, are other craft-related ways to do something similar online. There are any number of printable templates to be found online, including one of my favorite's for younger kids, the [Wearable Slide Rule Bangle Bracelet](https://www.instructables.com/Wearable-Slide-Rule-Bangle-Bracelet) found at Instructables.
...
![Aristo 903 Scholar, front](./_images/edu/edu-51.jpg)

</div>

<div class="ke-image-feature-item">

![Aristo 903 Scholar, back](./_images/edu/edu-52.jpg)

</div>

</div>

<p class="ke-image-feature-caption">Aristo 903 Scholar - Front / Back</p>
...
![Pickett 121 Microline, front](./_images/edu/edu-53.jpg)

</div>

<div class="ke-image-feature-item">

![Pickett 121 Microline, back](./_images/edu/edu-54.jpg)

</div>

</div>

<p class="ke-image-feature-caption">Pickett 121 Microline - Front / Back</p>
...
![Sterling Precision, front](./_images/edu/edu-55.jpg)

</div>

<div class="ke-image-feature-item">

![Sterling Precision, back](./_images/edu/edu-56.jpg)

</div>

</div>

<p class="ke-image-feature-caption">Sterling Precision - Front / Back</p>
...
![Acumath 600T, front](./_images/edu/edu-57.jpg)

</div>

<div class="ke-image-feature-item">

![Acumath 600T, back](./_images/edu/edu-58.jpg)

</div>

</div>

<p class="ke-image-feature-caption">Acumath 600T - Front / Back</p>

</div>

<div class="ke-figure">

![Jay's classroom wall, covered with slide rules](./_images/edu/edu-59.jpg)

<p class="ke-figure-caption">Creating an environment for kids to learn math could be as simple as posters on the wall or student work on display. I prefer to surround them with a display of mathematics' past. My collection of slide rules adorns the back wall. Most collectors, in an attempt to preserve them, keep slide rules locked out of sight in their cases. I prefer to use and admire them.</p>
